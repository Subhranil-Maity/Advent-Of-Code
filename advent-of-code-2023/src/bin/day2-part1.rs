    ...
    pub fn new(s: &str)->Game{
        ...
        for round in rounds{
            ...
            for type_ in type_t{
                ...
                let g = type_.clone().replace(f.as_str() , "").chars().next().unwrap();
                match g{
                    'r' => {if game.r < fi {game.r = fi}},
                    'g' => {if game.g < fi {game.g = fi}},
                    'b' => {if game.b < fi {game.b = fi}},
                    n => {
                       panic!("...{}...", n);
                    } 
                }
